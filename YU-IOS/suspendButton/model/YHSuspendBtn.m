...
-(void)setOnclickListenerWithPayCent:(PayCentBlock)payBlock PerCentBlock:(PerCentBlock)perBlock LogoutBlock:(LogoutBlock)logoutBlock UpUserBlock:(UpUserBlock)upUserBlock OpenSiginBlock:(OpenSiginBlock)opensiginBlock
{
    ...
    self.opensiginBlock = opensiginBlock;
}
...
- (instancetype)initWithImageName:(NSString*)name
{
    ...
    if(self = [super init])
    {
        ...
        FLAnimatedImage *gifimage = [[FLAnimatedImage alloc] initWithAnimatedGIFData:[NSData dataWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"cat" ofType:@"gif"]]];
        FLAnimatedImageView *gifimageview = [[FLAnimatedImageView alloc] init];
        gifimageview.frame = (CGRect){0, 0,folatViewHeght*SCALEY, folatViewHeght*SCALEY};
        gifimageview.animatedImage = gifimage;
        [self.mainImageButton addSubview:gifimageview];
